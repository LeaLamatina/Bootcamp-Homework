...
with open("PyBank_txt", "w") as Katrina:
#    PyBank_Solution = csv.writer(Katrina)
    print("Budget Snapshot", file=Katrina)
    print("--------------------------", file=Katrina)
    print("Total Number of Months: ", Months, file=Katrina)
    print("Net Profit/Loss over", Months, "Months: ", PLTot, file=Katrina)
    print("--------------------------", file=Katrina)
    print("Average Change: ", averageDiff, file=Katrina)
    print("Greatest Increase: ", maxDate, " > ", maxDiff, file=Katrina)
    print("Greatest Decrease: ", minDate, " > ", minDiff, file=Katrina)
    print("--------------------------", file=Katrina)